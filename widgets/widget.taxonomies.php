...
class Taxonomies_Widget Extends \WP_Widget {
  ...
  function __construct(){
    parent::__construct (
      ...
      I18n::t('Encyclopedia Taxonomies'),
      Array('description' => I18n::t('Displays your encyclopedia taxonomies like Categories, Tags, etc.'))
    );
  }
  ...
  function Form ($settings){
    ...
    <p>
      <input type="checkbox" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>" <?php Checked($this->getOption('count')==True); ?> >
      <label for="<?php echo $this->get_field_id('count'); ?>"><?php Echo I18n::t( 'Show term counts.' ); ?></label>
    </p>
    ...
    <p>
      ...
      <option value="slug" <?php Selected($this->getOption('orderby'), 'slug') ?>><?php Echo I18n::t('Slug') ?></option>
      </select>
    </p>
  ...
  function Widget ($args, $settings){
    ...
    WP_List_Categories(Array(
      ...
      'show_count' => $this->getOption('count'),
