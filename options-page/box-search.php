...
<tr>
	...
	<td>
    <input type="number" value="2" class="short" readonly="readonly">
    <?php Echo $this->t('characters', 'characters unit') ?><span class="asterisk">*</span><br>
    <small>
...
<tr>
	...
	<td>
    <input type="number" value="400" class="short" readonly="readonly">
    <?php Echo $this->t('ms', 'milliseconds time unit') ?><span class="asterisk">*</span><br>
    <small>
