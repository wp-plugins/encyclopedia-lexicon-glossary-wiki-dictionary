...
<tr>
    ...
    <?php Echo $this->t('characters', 'characters unit') ?><?php Echo $this->Pro_Notice('unlock') ?><br>
    <small>
...
<tr>
    ...
    <?php Echo $this->t('ms', 'milliseconds time unit') ?><?php Echo $this->Pro_Notice('unlock') ?><br>
    <small>
